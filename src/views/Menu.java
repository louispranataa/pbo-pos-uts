...
public class Menu extends javax.swing.JFrame {
    ...
    private Produk produkFrame = null;
    private Pengguna penggunaFrame = null;
    private Transaksi transaksiFrame = null;
    private Log logFrame = null;
    ...
    private void penggunaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_penggunaActionPerformed
        ...
        if (penggunaFrame == null || !penggunaFrame.isDisplayable()) {
            penggunaFrame = new Pengguna();
            penggunaFrame.setVisible(true);
        } else {
            penggunaFrame.toFront();
            penggunaFrame.requestFocus();
        }
    ...
    private void keluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keluarActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            LogService.tambahLog("Keluar", "User " + namaUser + " Keluar Aplikasi");
    ...
    private void produkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_produkActionPerformed
        // TODO add your handling code here:
         if (produkFrame == null || !produkFrame.isDisplayable()) {
            produkFrame = new Produk();
            produkFrame.setVisible(true);
        } else {
            produkFrame.toFront(); // Bawa ke depan jika sudah ada
            produkFrame.requestFocus();
        }
